...
export default function Homepage () {
    ...
    return (
       <div className="avenir">
           ...
           <p class="lh-title ml3">Before signing up or logging into xxxx, please make sure you're signed up and logged into your <a href="https://metamask.io/">Metamask account</a>. For those of you new to the Ethereum blockchain, Metamask connects you to the Ethereum blockchain. It also acts like a digital wallet and you'll need a bit of ether cryptocurrency to engage with the blockchain.
